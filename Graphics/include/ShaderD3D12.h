...
namespace EduEngine
{
	inline D3D12_SHADER_VISIBILITY GetShaderVisibility(EDU_SHADER_TYPE type)
	{
		switch (type)
		{
		case EduEngine::EDU_SHADER_TYPE_VERTEX: return D3D12_SHADER_VISIBILITY_VERTEX;
		case EduEngine::EDU_SHADER_TYPE_GEOMETRY: return D3D12_SHADER_VISIBILITY_GEOMETRY;
		case EduEngine::EDU_SHADER_TYPE_PIXEL: return D3D12_SHADER_VISIBILITY_PIXEL;
		case EduEngine::EDU_SHADER_TYPE_COMPUTE: return D3D12_SHADER_VISIBILITY_ALL;
